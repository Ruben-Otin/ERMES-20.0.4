...
ERMES 20.0 solves numerically the time-harmonic Maxwell's equations with the Finite Element Method (FEM). This chapter presents the FEM approaches implemented in ERMES 20.0 along with its advantages and disadvantages. The FEM formulations implemented in ERMES 20.0 are: 
\begin{itemize}
	\itemsep0em 
...
\subsection{$\textbf{A}-\phi$ potentials}
...
\section{Local $L^{2}$ projection method with nodal and bubble elements}\label{L2PNodalBubb}
