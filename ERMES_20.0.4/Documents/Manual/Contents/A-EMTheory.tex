...
In ERMES 20.0 there are implemented two types of materials: isotropic homogeneous linear materials and cold plasma, being the cold plasma a type of inhomogeneous gyrotropic linear material. In the cold plasma model implemented in ERMES, the field \textbf{D} is related with \textbf{E} through a position dependant 3x3 Hermitian tensor with off-diagonal complex conjugate terms. The cold plasma permittivity tensor is calculated from a given electron density distribution and a magnetic flux density following the equations provided in \cite{Swanson}.
