...
#if !defined(BiCG_COMPLEX_SOLVER_H_INCLUDED)
#define BiCG_COMPLEX_SOLVER_H_INCLUDED
...
namespace Kratos
{
    ...
    //*********************************************************************    
    class BiCGComplexSolver : public ComplexSolver
    {
     public:

         BiCGComplexSolver(int NumThreads,
			               int MaxIterations, 
			               int StepIterations,
                           double Tolerance,
	 ...
	 private:
		 ...
		 void Solve_BiCG       (ComplexMatrixType& A, ComplexVectorType& b, ComplexVectorType& x);
