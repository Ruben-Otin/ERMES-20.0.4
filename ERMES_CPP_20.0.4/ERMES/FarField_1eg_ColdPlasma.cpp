...
#include "FarField_1eg_ColdPlasma.h"
...
{  	
    ...
    //* - Global DOFs Ids
    //********************************************************************************************************************************	
    void FarField_1eg_ColdPlasma::GetEquationIdVector( Vector<int>& EquationId )
    {
    ...
    //* - Area of the element
    //********************************************************************************************************************************	
    double FarField_1eg_ColdPlasma::Calculate_Area() 
    {
    ...
    //* - Exterior normal 
    //********************************************************************************************************************************	
    void FarField_1eg_ColdPlasma::Calculate_Exterior_Normal( Vector<double>& Next )
    {
		double v1[ 3 ], v2[ 3 ];
    ...
    //********************************************************************************************************************************
    String FarField_1eg_ColdPlasma::Get_Wave_Type()
    {
        String sWaveType;
    ...
    //********************************************************************************************************************************
    void FarField_1eg_ColdPlasma::Calculate_DN( double DN[ 2 ][ 3 ] )
    {
    ...
    //********************************************************************************************************************************
    void FarField_1eg_ColdPlasma::Calculate_Edge_Lengths( Vector<double>& eLength )
    {
    ...
    //********************************************************************************************************************************
    void FarField_1eg_ColdPlasma::Get_Vertices_Surface_Coordinates( Vector<double>& pX,  Vector<double>& pY )
    {
    ...
    //********************************************************************************************************************************
	void FarField_1eg_ColdPlasma::Whitney2D_Ni_1st( Matrix<double>& Nx, Matrix<double>& Ny, Vector<double>& cX, Vector<double>& cY )
	{
		double L1, L2, L3;
    ...
    //********************************************************************************************************************************
    void FarField_1eg_ColdPlasma::jwK_OnGaussPoints( Vector< std::complex<double> >& jwKgp, Matrix<double>& N )
    {
    ...
    //********************************************************************************************************************************	
    void FarField_1eg_ColdPlasma::GetStiffnessMatrix( Matrix< std::complex<double> >& StiffMatrix ) 
    {
