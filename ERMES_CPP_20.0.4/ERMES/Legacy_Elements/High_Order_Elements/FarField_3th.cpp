...
{  	
    ...
    **********************************************************************************/	
    void FarField_3th::SetFrequency(double NewFrequency)
    {
        freq = NewFrequency;
    }
    ...
    **********************************************************************************/	
    void FarField_3th::GetEquationIdVector(Vector<int>& EquationId)
    {
    ...
    **********************************************************************************/	
    void FarField_3th::GetStiffMatrix(Matrix<std::complex<double> >& StiffMatrix) 
    {
		const int numNodes = 10;
		const int numDofs  = numNodes*3;
