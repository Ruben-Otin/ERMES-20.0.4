...
{  	
    ...
    **********************************************************************************/	
    void GenericRobin_4th::GetEquationIdVector(Vector<int>& EquationId)
    {
    ...
    **********************************************************************************/	
    void GenericRobin_4th::GetStiffMatrix(Matrix<std::complex<double> >& StiffMatrix) 
    {
		const int numNodes = 15;
		const int numDofs  = numNodes*3;
