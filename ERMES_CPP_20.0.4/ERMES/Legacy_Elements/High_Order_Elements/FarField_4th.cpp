...
{  	
    ...
    **********************************************************************************/	
    void FarField_4th::SetFrequency(double NewFrequency)
    {
        freq = NewFrequency;
    }
    ...
    **********************************************************************************/	
    void FarField_4th::GetEquationIdVector(Vector<int>& EquationId)
    {
    ...
    **********************************************************************************/	
    void FarField_4th::GetStiffMatrix(Matrix<std::complex<double> >& StiffMatrix) 
    {
		const int numNodes = 15;
		const int numDofs  = numNodes*3;
		...
		std::complex<double> ccteNN(0.00,-jacob*freq*sqrt(eo/mu));
