...
{  	
    ...
    **********************************************************************************/	
    void GenericRobin_2nd::GetEquationIdVector(Vector<int>& EquationId)
    {
    ...
    **********************************************************************************/	
    void GenericRobin_2nd::GetStiffMatrix(Matrix<std::complex<double> >& StiffMatrix) 
    {
		const int numNodes = 6;
		const int numDofs  = numNodes*3;
