...
{  	
    ...
    **********************************************************************************/	
    void FarField_2nd::SetFrequency(double NewFrequency)
    {
        freq = NewFrequency;
    }
    ...
    **********************************************************************************/	
    void FarField_2nd::GetEquationIdVector(Vector<int>& EquationId)
    {
    ...
    **********************************************************************************/	
    void FarField_2nd::GetStiffMatrix(Matrix<std::complex<double> >& StiffMatrix) 
    {
		const int numNodes = 6;
		const int numDofs  = numNodes*3;
