...
{  	
    ...
    **********************************************************************************/	
    void FarField_2ndQ::SetFrequency(double NewFrequency)
    {
        freq = NewFrequency;
    }
    ...
    **********************************************************************************/	
    void FarField_2ndQ::GetEquationIdVector(Vector<int>& EquationId)
    {
    ...
    ***********************************************************************************/
    void FarField_2ndQ::Calculate_detJ(std::vector<double>& detJ,
    ...
    **********************************************************************************/	
    void FarField_2ndQ::GetStiffMatrix(Matrix<std::complex<double> >& StiffMatrix) 
    {
		const int numNodes = 6;
		const int numDofs  = numNodes*3;
		...
		std::complex<double> ccteNN(0.00, -freq*sqrt(eo/mu));
