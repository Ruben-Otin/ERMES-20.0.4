...
{  	
    ...
    **********************************************************************************/	
    void CoaxialPortTEM_3th::GetEquationIdVector(Vector<int>& EquationId)
    {
    ...
    **********************************************************************************/	
    void CoaxialPortTEM_3th::GetStiffMatrix(Matrix<std::complex<double> >& StiffMatrix) 
    {
		const int numNodes = 10;
		const int numDofs  = numNodes*3;
    ...
    **********************************************************************************/
	double CoaxialPortTEM_3th::getPortNumber()
	{
    ...
    * - Calculate area
    **********************************************************************************/
    double CoaxialPortTEM_3th::CalculateArea() 
	{
    ...
    * - Set up j*(k/mu) coef
    **********************************************************************************/
    std::complex<double> CoaxialPortTEM_3th::CalculateKMuCoef() 
	{
		//Freq = w = 2*pi*v
    ...
    **********************************************************************************/
    std::complex<double> CoaxialPortTEM_3th::CalculateNormalizationCoef() 
	{
		double freq = (*mProperties)(FREQUENCY);
    ...
    **********************************************************************************/
	void CoaxialPortTEM_3th::Calculate_r0(double* r0) 
	{
		Vector<double> cIBC   = (*mProperties)(COMPLEX_IBC),
    ...
    **********************************************************************************/
    void CoaxialPortTEM_3th::GetResidualVector(Vector<std::complex<double> >& ResidualVector) 
    {
        const int numNodes = 10;
		const int numDofs  = numNodes*3;
    ...
    **********************************************************************************/
	std::complex<double> CoaxialPortTEM_3th::getProjection()
	{
		const int numNodes = 10;
    ...
    **********************************************************************************/
	std::complex<double> CoaxialPortTEM_3th::getNormalization()
	{
		std::vector<double> cX; 
		std::vector<double>	cY; 
		std::vector<double>  W;
