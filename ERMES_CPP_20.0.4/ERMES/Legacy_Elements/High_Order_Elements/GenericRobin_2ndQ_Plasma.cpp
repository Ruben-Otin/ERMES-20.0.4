...
#include "GenericRobin_2ndQ_Plasma.h"
...
{  	
    ...
    //**********************************************************************************	
    void GenericRobin_2ndQ_Plasma::GetEquationIdVector( Vector<int>& EquationId )
    {
    ...
    //******************************************************************************************************************
    void GenericRobin_2ndQ_Plasma::Rotation_Matrix( Matrix<std::complex<double> >& T, double Bx, double By, double Bz )
    {    
        // Unit vectors
    ...
    //********************************************************************************************************************************
    void GenericRobin_2ndQ_Plasma::PermittivityTensor_OnGaussPoints( Vector<Matrix<std::complex<double> > >& TEgp, Matrix<double>& N )
    {
    ...
    //****************************************************************************************	
    double GenericRobin_2ndQ_Plasma::Calculate_Area() 
    {
    ...
    //***********************************************************************************
    void GenericRobin_2ndQ_Plasma::Calculate_detJ( Vector<double>& detJ, Vector<double>& cX, Vector<double>& cY )
    {
    ...
    //****************************************************************************************	
    void GenericRobin_2ndQ_Plasma::GetStiffMatrix( Matrix<std::complex<double> >& StiffMatrix ) 
    {
        // Loop indexes
        int i, j, gp;
