...
{   
    ...
    **********************************************************************************/	
    void JSource_2nd::GetEquationIdVector(Vector<int>& EquationId)
    {
    ...
    **********************************************************/
    double JSource_2nd::Calculate_Volume()
    {
         double det;
    ...
    **********************************************************************************/
    void JSource_2nd::GetResidualVector(Vector<std::complex<double> >& ResidualVector) 
    {
        int i,j;
