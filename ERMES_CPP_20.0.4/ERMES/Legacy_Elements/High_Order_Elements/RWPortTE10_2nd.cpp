...
{  	
    ...
    **********************************************************************************/	
    void RWPortTE10_2nd::GetEquationIdVector(Vector<int>& EquationId)
    {
    ...
    * - Set up beta/mu coef
    **********************************************************************************/
    std::complex<double> RWPortTE10_2nd::CalculateBetaMuCoef() 
	{
    ...
    **********************************************************************************/
	double RWPortTE10_2nd::CalculateWidth()
	{
    ...
    **********************************************************************************/
	double RWPortTE10_2nd::CalculateHeight()
	{
		Vector<double> cIBC   = (*mProperties)(COMPLEX_IBC),
					   cIBC2o = (*mProperties)(COMPLEX_IBC_2o),
					   cNF    = (*mProperties)(COMPLEX_NEUMANN_FLOW);
    ...
    **********************************************************************************/
    std::complex<double> RWPortTE10_2nd::CalculateN10() 
	{
    ...
    * - Calculate area
    **********************************************************************************/
    double RWPortTE10_2nd::CalculateArea() 
	{
    ...
    **********************************************************************************/
	void RWPortTE10_2nd::Calculate_b(double* b) 
	{
		Vector<double> cIBC   = (*mProperties)(COMPLEX_IBC),
					   cIBC2o = (*mProperties)(COMPLEX_IBC_2o),
					   cNF    = (*mProperties)(COMPLEX_NEUMANN_FLOW); 
    ...
    **********************************************************************************/
	void RWPortTE10_2nd::Calculate_t(double* t) 
	{
		Vector<double> cIBC   = (*mProperties)(COMPLEX_IBC),
					   cIBC2o = (*mProperties)(COMPLEX_IBC_2o),
					   cNF    = (*mProperties)(COMPLEX_NEUMANN_FLOW); 
    ...
    **********************************************************************************/
	void RWPortTE10_2nd::Calculate_r0(double* r0) 
	{
		Vector<double> cIBC   = (*mProperties)(COMPLEX_IBC),
					   cIBC2o = (*mProperties)(COMPLEX_IBC_2o); 
    ...
    **********************************************************************************/
    void RWPortTE10_2nd::GetResidualVector(Vector<std::complex<double> >& ResidualVector) 
    {
        const int numNodes = 6;
		const int numDofs  = numNodes*3;
    ...
    **********************************************************************************/	
    void RWPortTE10_2nd::GetStiffMatrix(Matrix<std::complex<double> >& StiffMatrix) 
    {
		const int numNodes = 6;
		const int numDofs  = numNodes*3;
    ...
    **********************************************************************************/
	double RWPortTE10_2nd::getPortNumber()
	{
		Vector<double> cIBC = (*mProperties)(COMPLEX_IBC);
    ...
    **********************************************************************************/
	std::complex<double> RWPortTE10_2nd::getProjection()
	{
		const int numNodes = 6;
    ...
    **********************************************************************************/
	std::complex<double> RWPortTE10_2nd::getNormalization()
	{
		std::vector<double> cX; 
		std::vector<double>	cY; 
		std::vector<double>  W;
