...
{  	
    ...
    **********************************************************************************/	
    void CoaxialPortTEM_4th::GetEquationIdVector(Vector<int>& EquationId)
    {
    ...
    **********************************************************************************/	
    void CoaxialPortTEM_4th::GetStiffMatrix(Matrix<std::complex<double> >& StiffMatrix) 
    {
		const int numNodes = 15;
		const int numDofs  = numNodes*3;
    ...
    **********************************************************************************/
	double CoaxialPortTEM_4th::getPortNumber()
	{
    ...
    * - Calculate area
    **********************************************************************************/
    double CoaxialPortTEM_4th::CalculateArea() 
	{
    ...
    * - Set up j*(k/mu) coef
    **********************************************************************************/
    std::complex<double> CoaxialPortTEM_4th::CalculateKMuCoef() 
	{
		//Freq = w = 2*pi*v
    ...
    **********************************************************************************/
    std::complex<double> CoaxialPortTEM_4th::CalculateNormalizationCoef() 
	{
		double freq = (*mProperties)(FREQUENCY);
    ...
    **********************************************************************************/
	void CoaxialPortTEM_4th::Calculate_r0(double* r0) 
	{
		Vector<double> cIBC   = (*mProperties)(COMPLEX_IBC),
    ...
    **********************************************************************************/
    void CoaxialPortTEM_4th::GetResidualVector(Vector<std::complex<double> >& ResidualVector) 
    {
        const int numNodes = 15;
		const int numDofs  = numNodes*3;
    ...
    **********************************************************************************/
	std::complex<double> CoaxialPortTEM_4th::getProjection()
	{
		const int numNodes = 15;
    ...
    **********************************************************************************/
	std::complex<double> CoaxialPortTEM_4th::getNormalization()
	{
		std::vector<double> cX; 
		std::vector<double>	cY; 
		std::vector<double>  W;
