...
#if !defined(KRATOS_VOLUME_ELEMENT_4TH)
#define KRATOS_VOLUME_ELEMENT_4TH 
...
namespace Kratos
{
    ...
    class VolumeElement_4th : public Element
    {
        public:

            VolumeElement_4th(NodesArrayType& rNodes, 
        ...
        private:
			...
			void LagrangeDerivatives3D_4th(Matrix<double>& dNdx, 
				                           Matrix<double>& dNdy, 
										   Matrix<double>& dNdz,
