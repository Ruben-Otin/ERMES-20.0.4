...
{  	
    ...
    **********************************************************************************/	
    void RWPortTE10_4th::GetEquationIdVector(Vector<int>& EquationId)
    {
    ...
    * - Set up beta/mu coef
    **********************************************************************************/
    std::complex<double> RWPortTE10_4th::CalculateBetaMuCoef() 
	{
    ...
    **********************************************************************************/
	double RWPortTE10_4th::CalculateWidth()
	{
    ...
    **********************************************************************************/
	double RWPortTE10_4th::CalculateHeight()
	{
		Vector<double> cIBC   = (*mProperties)(COMPLEX_IBC),
					   cIBC2o = (*mProperties)(COMPLEX_IBC_2o),
					   cNF    = (*mProperties)(COMPLEX_NEUMANN_FLOW);
    ...
    **********************************************************************************/
    std::complex<double> RWPortTE10_4th::CalculateN10() 
	{
    ...
    * - Calculate area
    **********************************************************************************/
    double RWPortTE10_4th::CalculateArea() 
	{
    ...
    **********************************************************************************/
	void RWPortTE10_4th::Calculate_b(double* b) 
	{
		Vector<double> cIBC   = (*mProperties)(COMPLEX_IBC),
					   cIBC2o = (*mProperties)(COMPLEX_IBC_2o),
					   cNF    = (*mProperties)(COMPLEX_NEUMANN_FLOW); 
    ...
    **********************************************************************************/
	void RWPortTE10_4th::Calculate_t(double* t) 
	{
		Vector<double> cIBC   = (*mProperties)(COMPLEX_IBC),
					   cIBC2o = (*mProperties)(COMPLEX_IBC_2o),
					   cNF    = (*mProperties)(COMPLEX_NEUMANN_FLOW); 
    ...
    **********************************************************************************/
	void RWPortTE10_4th::Calculate_r0(double* r0) 
	{
		Vector<double> cIBC   = (*mProperties)(COMPLEX_IBC),
					   cIBC2o = (*mProperties)(COMPLEX_IBC_2o); 
    ...
    **********************************************************************************/
    void RWPortTE10_4th::GetResidualVector(Vector<std::complex<double> >& ResidualVector) 
    {
        const int numNodes = 15;
		const int numDofs  = numNodes*3;
    ...
    **********************************************************************************/	
    void RWPortTE10_4th::GetStiffMatrix(Matrix<std::complex<double> >& StiffMatrix) 
    {
		const int numNodes = 15;
		const int numDofs  = numNodes*3;
    ...
    **********************************************************************************/
	double RWPortTE10_4th::getPortNumber()
	{
		Vector<double> cIBC = (*mProperties)(COMPLEX_IBC);
    ...
    **********************************************************************************/
	std::complex<double> RWPortTE10_4th::getProjection()
	{
		const int numNodes = 15;
    ...
    **********************************************************************************/
	std::complex<double> RWPortTE10_4th::getNormalization()
	{
		std::vector<double> cX; 
		std::vector<double>	cY;
		std::vector<double>  W;
