...
#if !defined(KRATOS_VOLUME_ELEMENT_2ND)
#define KRATOS_VOLUME_ELEMENT_2ND
...
namespace Kratos
{
    ...
    class VolumeElement_2nd : public Element
    {
        public:

            VolumeElement_2nd(NodesArrayType& rNodes, 
        ...
        private:
			...
			void LagrangeDerivatives3D_2nd(Matrix<double>& dNdx, 
				                           Matrix<double>& dNdy, 
										   Matrix<double>& dNdz,
