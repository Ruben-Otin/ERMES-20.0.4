...
namespace Kratos
{
	...
	void Modeler::PushHONodesOnVolume( int* NodesId, std::vector<int>& HONodesId )
	{
        ...
        if ( mElementOrder == 0 ) HONodesOnVolume(NodesId, HONodesId);
	...
	{
        if ( mElementOrder == 0 ) CreateHONodes_OnVolume(NodesId); 
	...
	//*************************************************************************************************
    //* - Creating new higher order node inside volume 
    //*************************************************************************************************
    ...
    {
        // Setting mNodesConnectivity size
        int numTotalNodes = mpModel->GetNodesArray().size();
        int numElements   = mElementsVector.size();

        // Resize mNodesConnectivity with the number of element corner nodes
        mNodesConnectivity.resize( numTotalNodes - numElements );        
               
        // Iterator over all the elements in the mesh
        Vector<Vector<unsigned int> >::iterator elements_it;

        // Element Id
        int ElementId = 0;

        // Loop over all the elements in the mesh
		for ( elements_it = mElementsVector.begin(); elements_it != mElementsVector.end(); ++elements_it )
		{
            Vector<unsigned int> ElementInfo = *elements_it;
    ...
    void Modeler::GenerateFarFieldElement( int* NodesId )
    {
        ...
        else if ( mElementOrder == 0 ) pElement = Element::Pointer( new FarField_1st ( nodes ) );
    ...
    void Modeler::PBC_RightLeft_TKT( std::vector<int>& HONodesId, Vector<int>& IdVector, Matrix<std::complex<double> >& StiffMatrix )
   {
    ...
    void Modeler::GenerateVolIntElement( int* NodesId, unsigned int PropertiesId )
    {
        ...
        if      ( mElementOrder == 0 ) Lagrange3D_Ni_1bb( N, cX, cY, cZ );
    ...
    //***********************************************************************************
    void Modeler::NaturalDerivatives3D_2ndQ( Matrix<double>& dNda, Matrix<double>& dNdb, Matrix<double>& dNdu, std::vector<double>& cX, std::vector<double>& cY, std::vector<double>& cZ )
    {
		int p;
		int numNodes  = 10;
    ...
    //**********************************************************************************
    void Modeler::Calculate_detJ( std::vector<double>& detJ, std::vector<double>& cX, std::vector<double>& cY, std::vector<double>& cZ, std::vector<Node::Pointer>& cnodes )
    {
		int i, p;
		int numNodes  = 10;
		int numPoints = cX.size();
    ...
    //* - Calculation of the Jacobian determinant
    //***********************************************************************************
    void Modeler::Calculate_detJ( std::vector<double>& detJ, std::vector<double>& cX, std::vector<double>& cY, std::vector<Node::Pointer>& cnodes )
    {
		int i, p;
		int numNodes  = 6;
		int numPoints = cX.size();
    ...
    //*************************************************
    void Modeler::FreeCDof( unsigned int NodeId, const Variable<double>& rVariable )
    {
          Node::Pointer pnode = mpModel->GetNode(NodeId-1);
    ...
    //*****************************************************************************************
    void Modeler::Calculate_Static_E_Element_GP( Vector<Vector<double> >& Static_E_OnElementGPs, int* NodesId, unsigned int PropertiesId )
    {
        std::vector<Node::Pointer> nodes;
    ...
    //*****************************************************************************************
    void Modeler::Calculate_Static_J_Element_GP( Vector<Vector<double> >& Static_J_OnElementGPs, int* NodesId, unsigned int PropertiesId )
    {
        std::vector<Node::Pointer> nodes;
    ...
    //*********************************************************************************************
    void Modeler::Calculate_Static_JouleH_Element_GP( Vector<double>& Static_JouleH_OnElementGPs, int* NodesId, unsigned int PropertiesId )
    {
        std::vector<Node::Pointer> nodes;
