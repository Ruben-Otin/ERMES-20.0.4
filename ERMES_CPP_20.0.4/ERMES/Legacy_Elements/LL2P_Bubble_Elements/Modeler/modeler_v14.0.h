    ...
    class Modeler
    {
      public:
       ...
       //*****************************************************************************
        ...
        void Apply_Jump_Integral          ( int* NodesId, unsigned int PropertiesId );
      ...
      private:
        ...
        std::map<unsigned int, std::vector<double> > mLNormal;
        std::map<unsigned int, std::vector<double> > mRNormal;
