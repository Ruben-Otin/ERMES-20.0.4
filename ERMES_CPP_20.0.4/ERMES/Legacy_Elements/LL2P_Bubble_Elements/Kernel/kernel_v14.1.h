...
namespace Kratos
{
    ...
    class Kernel
    {
      public:
        ...
        //***************************************************************************************************************
        // -  Printing linear elements from Bubble + 1st order element
        //***************************************************************************************************************
        void PrintHOElementInMesh_1bbToLinear( int* NodesId, unsigned int PropertiesId )
        {
            ...
            */
            ...
            // [2-4-3] 
            SubElLinear[0] = HONodesId[1];
            SubElLinear[1] = HONodesId[3];
            SubElLinear[2] = HONodesId[2];
		    SubElLinear[3] = HONodesId[4];
	        mElementIdCounter++;
            mpDefaultOutput->PrintHOElement(mElementIdCounter, SubElLinear);
            ...
            // [3-4-1] 
            SubElLinear[0] = HONodesId[2];
            SubElLinear[1] = HONodesId[3];
            SubElLinear[2] = HONodesId[0];
		    SubElLinear[3] = HONodesId[4];
	        mElementIdCounter++;
            mpDefaultOutput->PrintHOElement(mElementIdCounter, SubElLinear);
            
            // [4-2-1]
            SubElLinear[0] = HONodesId[3];
            SubElLinear[1] = HONodesId[1];
            SubElLinear[2] = HONodesId[0];
		    SubElLinear[3] = HONodesId[4];
	        mElementIdCounter++;
