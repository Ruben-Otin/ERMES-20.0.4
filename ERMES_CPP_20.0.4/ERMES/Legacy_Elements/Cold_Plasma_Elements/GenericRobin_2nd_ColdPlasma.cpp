...
#include "GenericRobin_2nd_ColdPlasma.h"
...
{  	
    ...
    //*************************************************************************************************************************************	
    void GenericRobin_2nd_ColdPlasma::GetEquationIdVector( Vector<int>& EquationId )
    {
    ...
    //*************************************************************************************************************************************
    void GenericRobin_2nd_ColdPlasma::Rotation_Matrix( Matrix<std::complex<double> >& T, double Bx, double By, double Bz )
    {    
        // Unit vectors
    ...
    //*************************************************************************************************************************************
    void GenericRobin_2nd_ColdPlasma::PermittivityTensor_OnGaussPoints( Vector<Matrix<std::complex<double> > >& TEgp, Matrix<double>& N )
    {
    ...
    //*************************************************************************************************************************************	
    double GenericRobin_2nd_ColdPlasma::Calculate_Area() 
    {
    ...
    //*************************************************************************************************************************************
    void GenericRobin_2nd_ColdPlasma::Calculate_detJ( Vector<double>& detJ, Vector<double>& cX, Vector<double>& cY )
    {
    ...
    //*************************************************************************************************************************************	
    void GenericRobin_2nd_ColdPlasma::GetStiffnessMatrix( Matrix<std::complex<double> >& StiffMatrix ) 
    {
        // Loop indexes
        int i, j, gp;
        ...
        std::complex<double> cCoef( -vPSC[0], -vPSC[1] );
