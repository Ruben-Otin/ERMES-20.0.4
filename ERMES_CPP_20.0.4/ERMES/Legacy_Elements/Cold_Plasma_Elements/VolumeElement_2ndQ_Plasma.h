...
#if !defined(KRATOS_VOLUME_ELEMENT_2NDQ_PLASMA)
#define KRATOS_VOLUME_ELEMENT_2NDQ_PLASMA
...
namespace Kratos
{
    ...
    class VolumeElement_2ndQ_Plasma : public Element
    {
        public:

            VolumeElement_2ndQ_Plasma( NodesArrayType&     rNodes, 
