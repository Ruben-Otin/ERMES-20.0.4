...
#if !defined(KRATOS_FAR_FIELD_2NDQ_DIVD_PLASMA)
#define  KRATOS_FAR_FIELD_2NDQ_DIVD_PLASMA

#include "../includes/element.h"

namespace Kratos
{
    class FarField_2ndQ_DivD_Plasma: public Element
    {
        public:

            FarField_2ndQ_DivD_Plasma( NodesArrayType& rNodes ) : Element( rNodes )
            {
        ...
        private:
            ...
            void ExtNormal_OnGaussPoints( Vector<Vector<double> >& eNgp, Vector<double>& cX, Vector<double>& cY );
