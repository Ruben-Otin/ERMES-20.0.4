...
{   
    ...
    //************************************************************************************	
    void VolumeElement_2ndQ_DivD_Plasma::Set_Plasma_or_IHL() 
    { 
        // Material properties
                                                                    ...
                                                                    Matrix<double>& dNdz )
    {
        ...
        std::complex<double> Traza;
        std::complex<double> invTr;
        ...
        for ( int gp=0; gp<numGaussPoints; gp++ ) 
        {
            ...
            Traza = ( TEgp[gp][0][0] + TEgp[gp][1][1] + TEgp[gp][2][2] ) / 3.0;

            if ( abs(Traza) > 0.0 ) invTr = 1.0 / ( Traza * std::conj( Traza ) );
            else                    invTr = 1.0;
    ...
    //*************************************************************************************************
    void VolumeElement_2ndQ_DivD_Plasma::Rotation_Matrix( Matrix<std::complex<double> >& T, 
