...
#include "GenericRobin_1st_ColdPlasma.h"
...
{  	
    ...
    //*************************************************************************************************************************************	
    void GenericRobin_1st_ColdPlasma::GetEquationIdVector( Vector<int>& EquationId )
    {
    ...
    //*************************************************************************************************************************************
    void GenericRobin_1st_ColdPlasma::Rotation_Matrix( Matrix<std::complex<double> >& T, double Bx, double By, double Bz )
    {    
        // Unit vectors
    ...
    //*************************************************************************************************************************************
    void GenericRobin_1st_ColdPlasma::PermittivityTensor_OnGaussPoints( Vector<Matrix<std::complex<double> > >& TEgp, Matrix<double>& N )
    {
    ...
    //*************************************************************************************************************************************	
    double GenericRobin_1st_ColdPlasma::Calculate_Area() 
    {
    ...
    //*************************************************************************************************************************************	
    void GenericRobin_1st_ColdPlasma::GetStiffnessMatrix( Matrix<std::complex<double> >& StiffMatrix ) 
    {
        // Loop indexes
        int i, j, gp;
