...
#include "JSource_3sb_FullWave.h"
...
{ 
    ...
    //*****************************************************************************************************************
    void JSource_3sb_FullWave::GetEquationIdVector( Vector<int>& EquationId )
    {
    ...
    // - Element volume
    //*****************************************************************************************************************
    double JSource_3sb_FullWave::Calculate_Volume()
    {
        double Det;
    ...
    //* - Cartesian sources
    //*****************************************************************************************************************
    void JSource_3sb_FullWave::Get_CartesianXYZ_Sources( Vector< std::complex<double> >& cJx, 
    ...
    //*****************************************************************************************************************
    void JSource_3sb_FullWave::Get_Axisymmetric_Sources( Vector< std::complex<double> >& cJx, 
		                                                 Vector< std::complex<double> >& cJy, 
		                                                 Vector< std::complex<double> >& cJz )  
    {
        // Axisymmetric source
    ...
    //*****************************************************************************************************************
    void JSource_3sb_FullWave::Get_PlasmaModeJs_Sources( Vector< std::complex<double> >& cJx, 
		                                                 Vector< std::complex<double> >& cJy, 
		                                                 Vector< std::complex<double> >& cJz ) 
    {
		// Torus major radius
    ...
    //*****************************************************************************************************************
    void JSource_3sb_FullWave::Get_J_Imposed_OnNodes( std::map< unsigned int, Vector<double> >& rJimp, 
    ...
    //* - Residual vector
    //*****************************************************************************************************************
    void JSource_3sb_FullWave::GetResidualVector( Vector< std::complex<double> >& ResidualVector ) 
    {
		...
		// Adding integral to residual vector
		for( int i=0; i<mNumNodes; i++ )
		{
			...
			{		
                ...
                for( int gp=0; gp<numGaussPoints; gp++ )
				{
					IntgVol_NiNj += W[ gp ] * N[ i ][ gp ] * N[ j ][ gp ];
				}
