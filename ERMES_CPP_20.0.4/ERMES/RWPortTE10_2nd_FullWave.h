...
#if !defined(KRATOS_RWPORT_TE10_2ND_FULLWAVE)
#define KRATOS_RWPORT_TE10_2ND_FULLWAVE

#include "../includes/element.h"

namespace Kratos
{
    class RWPortTE10_2nd_FullWave : public Element
    {
      public:

        RWPortTE10_2nd_FullWave( NodesArrayType& rNodes, Properties::Pointer rProperties ) : Element( rNodes, rProperties )
        {
            mNumNodes = 6;
            mNumDofs  = 18; 
