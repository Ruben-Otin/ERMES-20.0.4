...
#if !defined(KRATOS_GENERIC_ROBIN_3SB_FULLWAVE)
#define KRATOS_GENERIC_ROBIN_3SB_FULLWAVE

#include "../includes/element.h"

namespace Kratos
{
    class GenericRobin_3sb_FullWave : public Element
    {
      public:

        GenericRobin_3sb_FullWave( NodesArrayType& rNodes, Properties::Pointer rProperties ) : Element( rNodes, rProperties )
        {
            mNumNodes = 6;
            mNumDofs  = 18; 
