...
#include "JSource_2eg_FullWave.h"
...
{   
    ...
    //*****************************************************************************************************************	
    void JSource_2eg_FullWave::GetEquationIdVector( Vector<int>& EquationId )
    {
    ...
    //* - Element volume
    //*****************************************************************************************************************
    double JSource_2eg_FullWave::Calculate_Volume()
    {
        double Det;
    ...
    //*****************************************************************************************************************
    void JSource_2eg_FullWave::Calculate_DN( double DN[ 3 ][ 4 ] )
    {
    ...
    //*****************************************************************************************************************
    void JSource_2eg_FullWave::Calculate_Edge_Lengths( Vector<double>& eLength )
    {
    ...
    //*****************************************************************************************************************
	void JSource_2eg_FullWave::Whitney3D_Ni_1st( Matrix<double>& Nx, Matrix<double>& Ny, Matrix<double>& Nz,
    ...
    //*****************************************************************************************************************
    // - Edge IDs and opposite node IDs for a face base
    //*****************************************************************************************************************
	void JSource_2eg_FullWave::Face_Base( int edgeBase[ 2 ], int nodeBase[ 2 ], int nodeID[ 3 ], int edgeID[ 3 ], int oppnID[ 3 ] )
	{
    ...
    //*****************************************************************************************************************
    // - Face bases ordering - Fy:[0-3] - Fz:[4-7]
    //*****************************************************************************************************************
	void JSource_2eg_FullWave::Order_Face_Bases( int n[ 8 ], int e[ 8 ] )
	{
		// Local face base IDs 
		int edgeBase[ 2 ];
		int nodeBase[ 2 ];
    ...
    //*****************************************************************************************************************
	void JSource_2eg_FullWave::Whitney3D_Ni_2nd( Matrix<double>& Nx, Matrix<double>& Ny, Matrix<double>& Nz,
		                                         Vector<double>& cX, Vector<double>& cY, Vector<double>& cZ )
	{
		int numPoints = cX.size();
    ...
    //* - Cartesian sources
    //*****************************************************************************************************************
    void JSource_2eg_FullWave::Get_CartesianXYZ_Sources( Vector< std::complex<double> >& cJx, 
    ...
    //*****************************************************************************************************************
    void JSource_2eg_FullWave::Get_Axisymmetric_Sources( Vector< std::complex<double> >& cJx, 
		                                                 Vector< std::complex<double> >& cJy, 
		                                                 Vector< std::complex<double> >& cJz )  
    {
        // Axisymmetric source
    ...
    //*****************************************************************************************************************
    void JSource_2eg_FullWave::Get_PlasmaModeJs_Sources( Vector< std::complex<double> >& cJx, 
		                                                 Vector< std::complex<double> >& cJy, 
		                                                 Vector< std::complex<double> >& cJz ) 
    {
		// Torus major radius
    ...
    //*****************************************************************************************************************
    void JSource_2eg_FullWave::Get_J_Imposed_OnNodes( std::map< unsigned int, Vector<double> >& rJimp, 
    ...
    //* - Residual vector
    //*****************************************************************************************************************
    void JSource_2eg_FullWave::GetResidualVector( Vector< std::complex<double> >& ResidualVector ) 
    {
	    ...
	    for( int i=INI_I; i<END_I; i++ )
	    {
            ...
            ResidualVector[ i + POS_I ] += vIntg_Ni_cJa;
	    }
