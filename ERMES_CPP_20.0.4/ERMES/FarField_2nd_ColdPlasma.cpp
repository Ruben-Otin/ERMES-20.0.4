...
#include "FarField_2nd_ColdPlasma.h"
...
{  	
    ...
    //********************************************************************************************************************************	
    void FarField_2nd_ColdPlasma::GetEquationIdVector( Vector<int>& EquationId )
    {
    ...
    //* - Area of the element
    //********************************************************************************************************************************	
    double FarField_2nd_ColdPlasma::Calculate_Area()
    {
    ...
    //* - Exterior normal 
    //********************************************************************************************************************************	
    void FarField_2nd_ColdPlasma::Calculate_ExtNormal( Vector<double>& extN )
    {
        double v1[ 3 ], v2[ 3 ];
    ...
    //********************************************************************************************************************************
    String FarField_2nd_ColdPlasma::Get_Wave_Type()
    {
        String sWaveType;
    ...
    //********************************************************************************************************************************
    //* - Permittivity tensor on Gauss points ( extrapolating TE on vertices to GPs with N1st )
    //********************************************************************************************************************************
    void FarField_2nd_ColdPlasma::PermittivityTensor_OnGaussPoints( Vector< Matrix< std::complex<double> > >& TEgp, Vector<double>& cX, Vector<double>& cY )
    {
        // Permittivity tensor on vertices
        Vector< Matrix< std::complex<double> > > TEvt( mNumVerts );
        ...
        { 
            mpColdPlasma->Get_PermittivityTensor_OnNode( TEvt[ i ], mNodes[ i ], mFreq );
        }

        // 1st order Lagrangian base on Gauss points
		Matrix<double> N1st;

		Lagrange2D_Ni_1st( N1st, cX, cY );
        ...
        // Permittivity tensor on Gauss points extrapolated from vertices with N1st
    ...
    //********************************************************************************************************************************
    //* - Wave vector on Gauss points ( extrapolating TK on vetices to GPs with N1st )
    //********************************************************************************************************************************
    void FarField_2nd_ColdPlasma::jwK_OnGaussPoints( Vector< std::complex<double> >& jwKgp, Vector<double>& cX, Vector<double>& cY )
    {
        // Wave vectors on nodes
        Vector< std::complex<double> > jwKvt( mNumVerts );
    ...
    //********************************************************************************************************************************
    void FarField_2nd_ColdPlasma::Get_invTau_OnGaussPoints( Vector< std::complex<double> >& invTau, Vector< Matrix< std::complex<double> > >& TEgp )
    {
	...
	//* - Stiffness matrix
	//********************************************************************************************************************************
	void FarField_2nd_ColdPlasma::GetStiffnessMatrix( Matrix<std::complex<double> >& StiffMatrix )
	{
    ...
    //********************************************************************************************************************************	
    void FarField_2nd_ColdPlasma::Get_Non_Regularized_Matrix( Matrix< std::complex<double> >& StiffMatrix ) 
    {
		// Constants
        double pi = 3.14159265358979;
        double mu = pi * 4.0e-7;
        ...
        // 2nd order Lagrangian base on Gauss points
		Matrix<double> N;
    ...
    //********************************************************************************************************************************	
    void FarField_2nd_ColdPlasma::Get_Stiffness_Matrix_Ef( Matrix< std::complex<double> >& StiffMatrix ) 
    {
		// Constants
        double pi = 3.14159265358979;
        double mu = pi * 4.0e-7;
        ...
        PermittivityTensor_OnGaussPoints( TEgp, cX, cY );
    ...
    //********************************************************************************************************************************	
    void FarField_2nd_ColdPlasma::Get_Stiffness_Matrix_AV( Matrix< std::complex<double> >& StiffMatrix ) 
    {
        // Constants
        double pi = 3.14159265358979;
        double mu = pi * 4.0e-7;
