...
#include "CoaxialPortTEM_2eg_FullWave.h"
...
{  	
    ...
    //*******************************************************************************************************	
    void CoaxialPortTEM_2eg_FullWave::GetEquationIdVector( Vector<int>& EquationId )
    {
    ...
    //* - Area of the element
    //*******************************************************************************************************
    double CoaxialPortTEM_2eg_FullWave::Calculate_Area() 
	{
    ...
    //*******************************************************************************************************
    std::complex<double> CoaxialPortTEM_2eg_FullWave::Calculate_KMuCoeff() 
	{
    ...
    //*******************************************************************************************************
    std::complex<double> CoaxialPortTEM_2eg_FullWave::Calculate_NrmCoeff() 
	{
		// Material properties of the coaxial port
		Vector<double> CC_MatProp = (*mProperties)( SINUSOIDAL_SURFACE_CURRENT ); 
    ...
    //*******************************************************************************************************
	void CoaxialPortTEM_2eg_FullWave::Calculate_r0( double* r0 ) 
	{
    ...
    //*******************************************************************************************************
	double CoaxialPortTEM_2eg_FullWave::GetPortNumber()
	{
    ...
    //* - Exterior normal 
    //*******************************************************************************************************	
    void CoaxialPortTEM_2eg_FullWave::Calculate_Exterior_Normal( Vector<double>& Next )
    {
		double v1[ 3 ], v2[ 3 ];
    ...
    //*******************************************************************************************************
    void CoaxialPortTEM_2eg_FullWave::Get_CoPlanar_XY_Axis( Vector<double>& X_axis,  Vector<double>& Y_axis )
	{
    ...
    //*******************************************************************************************************
    void CoaxialPortTEM_2eg_FullWave::Get_Vertices_Surface_Coordinates( Vector<double>& pX,  Vector<double>& pY )
    {
    ...
    //*******************************************************************************************************
    void CoaxialPortTEM_2eg_FullWave::Calculate_DN( double DN[ 2 ][ 3 ] )
    {
    ...
    //*******************************************************************************************************
    void CoaxialPortTEM_2eg_FullWave::Calculate_Edge_Lengths( Vector<double>& eLength )
    {
    ...
    //*******************************************************************************************************
	void CoaxialPortTEM_2eg_FullWave::Whitney2D_Ni_1st( Matrix<double>& Nx, Matrix<double>& Ny, Vector<double>& cX, Vector<double>& cY )
	{
		double L1, L2, L3;
    ...
    //******************************************************************************************************************************************
	void CoaxialPortTEM_2eg_FullWave::Face_Base( int edgeBase[ 2 ], int nodeBase[ 2 ], int nodeID[ 3 ], int edgeID[ 3 ], int oppnID[ 3 ] )
	{
    ...
    //******************************************************************************************************************************************
	void CoaxialPortTEM_2eg_FullWave::Order_Face_Bases( int n[ 2 ], int e[ 2 ] )
	{
		// Local face base IDs 
		int edgeBase[ 2 ];
		int nodeBase[ 2 ];
    ...
    //******************************************************************************************************************************************
	void CoaxialPortTEM_2eg_FullWave::Whitney2D_Ni_2nd( Matrix<double>& Nx, Matrix<double>& Ny, Vector<double>& cX, Vector<double>& cY )
	{
		int numPoints = cX.size();
    ...
    //*******************************************************************************************************
    void CoaxialPortTEM_2eg_FullWave::Input_Field_Vector( Vector<double>& Fx, Vector<double>& Fy, Vector<double>& cX, Vector<double>& cY )
	{
        // XY axis of the co-planar coordinate system 
        Vector<double> X_axis, Y_axis;
    ...
    //* - Residual vector 
    //*******************************************************************************************************
    void CoaxialPortTEM_2eg_FullWave::GetResidualVector( Vector< std::complex<double> >& ResidualVector ) 
    {
        ...
        // Scale factor on Ein for a given input power
    ...
    //* - Stiffness matrix
    //*******************************************************************************************************	
    void CoaxialPortTEM_2eg_FullWave::GetStiffnessMatrix( Matrix< std::complex<double> >& StiffMatrix ) 
    {
		// Initializing matrix
		...
		for( int i=0; i<mNumBases; i++ )
		{
			for( int j=i; j<mNumBases; j++ )
			{
				...
				EdgeBaseMatrix[ i ][ j ] = mcKMu * sIntg_NiNj;
			}
		}
    ...
    //*******************************************************************************************************
	std::complex<double> CoaxialPortTEM_2eg_FullWave::GetProjection()
	{
		// Gauss points
		Vector<double> cX, cY, W;
    ...
    //*******************************************************************************************************
	std::complex<double> CoaxialPortTEM_2eg_FullWave::GetNormalization()
	{
		// Gauss points
		Vector<double> cX, cY, W;
