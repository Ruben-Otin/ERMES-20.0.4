...
#if !defined(KRATOS_COAXIAL_PORT_TEM_3SB_FULLWAVE)
#define KRATOS_COAXIAL_PORT_TEM_3SB_FULLWAVE

#include "../includes/element.h"

namespace Kratos
{
    class CoaxialPortTEM_3sb_FullWave : public Element
    {
      public:

        CoaxialPortTEM_3sb_FullWave( NodesArrayType& rNodes, Properties::Pointer rProperties ) : Element( rNodes, rProperties )
        {
            mNumNodes = 6;
            mNumDofs  = 18; 
