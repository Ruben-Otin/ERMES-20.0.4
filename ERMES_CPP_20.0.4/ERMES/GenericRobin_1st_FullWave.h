...
#if !defined(KRATOS_GENERIC_ROBIN_1ST_FULLWAVE)
#define KRATOS_GENERIC_ROBIN_1ST_FULLWAVE

#include "../includes/element.h"

namespace Kratos
{
    class GenericRobin_1st_FullWave : public Element
    {
      public:

        GenericRobin_1st_FullWave( NodesArrayType& rNodes, Properties::Pointer rProperties ) : Element( rNodes, rProperties )   
        {
            mNumNodes = 3;
            mNumDofs  = 9; 
