...
#include "JSource_1st_FullWave.h"
...
{   
    ...
    //*****************************************************************************************************************	
    void JSource_1st_FullWave::GetEquationIdVector( Vector<int>& EquationId )
    {
    ...
    //* - Element volume
    //*****************************************************************************************************************
    double JSource_1st_FullWave::Calculate_Volume()
    {
        double Det;
    ...
    //* - Cartesian sources
    //*****************************************************************************************************************
    void JSource_1st_FullWave::Get_CartesianXYZ_Sources( Vector< std::complex<double> >& cJx, 
	...
	//*****************************************************************************************************************
    //* - Axysimmetric sources
    //*****************************************************************************************************************
    void JSource_1st_FullWave::Get_Axisymmetric_Sources( Vector< std::complex<double> >& cJx, 
		                                                 Vector< std::complex<double> >& cJy, 
		                                                 Vector< std::complex<double> >& cJz ) 
    {
        // Axysimmetric source
	...
	//*****************************************************************************************************************
    //* - Plasma modes and Helicoidal J sources
    //*****************************************************************************************************************
    void JSource_1st_FullWave::Get_PlasmaModeJs_Sources( Vector< std::complex<double> >& cJx, 
		                                                 Vector< std::complex<double> >& cJy, 
		                                                 Vector< std::complex<double> >& cJz ) 
    {
		// Torus major radius
    ...
    //*****************************************************************************************************************
    void JSource_1st_FullWave::Get_J_Imposed_OnNodes( std::map< unsigned int, Vector<double> >& rJimp, 
		                                              std::map< unsigned int, Vector<double> >& iJimp )
	{
		// J sources on nodes
		Vector< std::complex<double> > cJx( mNumNodes, std::complex<double>( 0.0, 0.0 ) );
		Vector< std::complex<double> > cJy( mNumNodes, std::complex<double>( 0.0, 0.0 ) );
		Vector< std::complex<double> > cJz( mNumNodes, std::complex<double>( 0.0, 0.0 ) );
    ...
    //* - Residual vector
    //*****************************************************************************************************************
    void JSource_1st_FullWave::GetResidualVector( Vector< std::complex<double> >& ResidualVector ) 
    {
		...
		for( int i=0; i<mNumNodes; i++ )
		{
			...
			{		
                if( i != j )
				{
					VolInt_NiNj = mVolume / 20.0;
				}
        	    else
				{
					VolInt_NiNj = mVolume / 10.0;		
				}
								
				ResidualVector[ i               ] += cJx[ j ] * VolInt_NiNj;
				ResidualVector[ i +   mNumNodes ] += cJy[ j ] * VolInt_NiNj;
				ResidualVector[ i + 2*mNumNodes ] += cJz[ j ] * VolInt_NiNj;
			}
		}
    }
} 