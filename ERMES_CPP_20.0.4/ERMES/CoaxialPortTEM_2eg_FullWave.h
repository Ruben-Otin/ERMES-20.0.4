...
#if !defined(KRATOS_COAXIAL_PORT_TEM_2EG_FULLWAVE)
#define KRATOS_COAXIAL_PORT_TEM_2EG_FULLWAVE

#include "../includes/element.h"

namespace Kratos
{
    class CoaxialPortTEM_2eg_FullWave : public Element
    {
      public:

        CoaxialPortTEM_2eg_FullWave( NodesArrayType& rNodes, Properties::Pointer rProperties ) : Element( rNodes, rProperties )
        {
            mNumFaces = 1;  
            mNumEdges = 3;
            mNumVerts = 3;
