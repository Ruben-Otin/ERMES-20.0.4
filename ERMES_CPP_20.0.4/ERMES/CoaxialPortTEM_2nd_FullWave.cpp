...
#include "CoaxialPortTEM_2nd_FullWave.h"
...
{  	
    ...
    //*******************************************************************************************************	
    void CoaxialPortTEM_2nd_FullWave::GetEquationIdVector( Vector<int>& EquationId )
    {
    ...
    //* - Area of the element
    //*******************************************************************************************************
    double CoaxialPortTEM_2nd_FullWave::Calculate_Area() 
	{
    ...
    //*******************************************************************************************************
    std::complex<double> CoaxialPortTEM_2nd_FullWave::Calculate_KMuCoeff() 
	{
    ...
    //*******************************************************************************************************
    std::complex<double> CoaxialPortTEM_2nd_FullWave::Calculate_NrmCoeff() 
	{
		// Material properties of the coaxial port
		Vector<double> CC_MatProp = (*mProperties)( SINUSOIDAL_SURFACE_CURRENT ); 
    ...
    //*******************************************************************************************************
	void CoaxialPortTEM_2nd_FullWave::Calculate_r0( double* r0 ) 
	{
    ...
    //*******************************************************************************************************
	double CoaxialPortTEM_2nd_FullWave::GetPortNumber()
	{
    ...
    //* - Residual vector 
    //*******************************************************************************************************
    void CoaxialPortTEM_2nd_FullWave::GetResidualVector( Vector< std::complex<double> >& ResidualVector ) 
    {
    ...
    //* - Stiffness matrix
    //*******************************************************************************************************	
    void CoaxialPortTEM_2nd_FullWave::GetStiffnessMatrix( Matrix< std::complex<double> >& StiffMatrix ) 
    {
    ...
    //*******************************************************************************************************
	std::complex<double> CoaxialPortTEM_2nd_FullWave::GetProjection()
	{
		// Gauss points
		Vector<double> cX, cY, W;
    ...
    //*******************************************************************************************************
	std::complex<double> CoaxialPortTEM_2nd_FullWave::GetNormalization()
	{
		// Gauss points
		Vector<double> cX, cY, W;
