...
#include "FarField_2nd_FullWave.h"
...
{  	
    ...
    //* - Global DOFs Ids
    //*******************************************************************************************************	
    void FarField_2nd_FullWave::GetEquationIdVector( Vector<int>& EquationId )
    {
    ...
    // - Area of the element
    //*******************************************************************************************************
    double FarField_2nd_FullWave::Calculate_Area()
    {
    ...
    //*******************************************************************************************************	
    void FarField_2nd_FullWave::GetStiffnessMatrix( Matrix< std::complex<double> >& StiffMatrix ) 
    {
		// Initializing matrix
        ...
        Matrix<double> N; Lagrange2D_Ni_2nd( N, cX, cY );
