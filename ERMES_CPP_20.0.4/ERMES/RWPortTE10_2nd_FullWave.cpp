...
#include "RWPortTE10_2nd_FullWave.h"
...
{  	
    ...
    //*******************************************************************************************************	
    void RWPortTE10_2nd_FullWave::GetEquationIdVector( Vector<int>& EquationId )
    {
    ...
    //* - Area of the element
    //*******************************************************************************************************
    double RWPortTE10_2nd_FullWave::Calculate_Area() 
	{
    ...
    //*******************************************************************************************************
    std::complex<double> RWPortTE10_2nd_FullWave::Calculate_BetaMuCoef() 
	{
    ...
    //*******************************************************************************************************
    std::complex<double> RWPortTE10_2nd_FullWave::Calculate_N10() 
	{
    ...
    //* - Waveguide width
    //*******************************************************************************************************
	double RWPortTE10_2nd_FullWave::Calculate_Width()
	{
		// Corners coordinates
    ...
    //* - Waveguide height
    //*******************************************************************************************************
	double RWPortTE10_2nd_FullWave::Calculate_Height()
	{
		// Corners coordinates
		Vector<double> cNF = (*mProperties)( COMPLEX_NEUMANN_FLOW );
		Vector<double> SSC = (*mProperties)( SINUSOIDAL_SURFACE_CURRENT );
    ...
    //* - b vector ( vertical ) 
    //*******************************************************************************************************
	void RWPortTE10_2nd_FullWave::Calculate_b( double* b ) 
	{
		Vector<double> cNF = (*mProperties)( COMPLEX_NEUMANN_FLOW );
		Vector<double> SSC = (*mProperties)( SINUSOIDAL_SURFACE_CURRENT );
    ...
    //* - t vector ( horizontal ) 
    //*******************************************************************************************************
	void RWPortTE10_2nd_FullWave::Calculate_t( double* t ) 
	{
		Vector<double> cNF = (*mProperties)( COMPLEX_NEUMANN_FLOW );
		Vector<double> SSC = (*mProperties)( SINUSOIDAL_SURFACE_CURRENT );
    ...
    //*******************************************************************************************************
	void RWPortTE10_2nd_FullWave::Calculate_r0( double* r0 ) 
	{
		Vector<double> cNF = (*mProperties)( COMPLEX_NEUMANN_FLOW );
    ...
    //*******************************************************************************************************
	double RWPortTE10_2nd_FullWave::GetPortNumber()
	{
    ...
    //* - Residual vector 
    //*******************************************************************************************************
    void RWPortTE10_2nd_FullWave::GetResidualVector( Vector< std::complex<double> >& ResidualVector ) 
    {
    ...
    //* -Stiffness matrix
    //*******************************************************************************************************	
    void RWPortTE10_2nd_FullWave::GetStiffnessMatrix( Matrix< std::complex<double> >& StiffMatrix ) 
    {
    ...
    //*******************************************************************************************************
	std::complex<double> RWPortTE10_2nd_FullWave::GetProjection()
	{
		// Gauss points
		Vector<double> cX, cY, W;
    ...
    //*******************************************************************************************************
	std::complex<double> RWPortTE10_2nd_FullWave::GetNormalization()
	{
		// Gauss points
		Vector<double> cX, cY, W;
