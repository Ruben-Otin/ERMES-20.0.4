...
{  	
    ...
    //********************************************************************************************************************************
    void FarField_1st_ColdPlasma::PermittivityTensor_OnGaussPoints( Vector< Matrix< std::complex<double> > >& TEgp, Matrix<double>& N )
    {
    ...
    //********************************************************************************************************************************
    void FarField_1st_ColdPlasma::jwK_OnGaussPoints( Vector< std::complex<double> >& jwKgp, Matrix<double>& N )
    {
    ...
    //********************************************************************************************************************************
    void FarField_1st_ColdPlasma::Get_invTau_OnGaussPoints( Vector< std::complex<double> >& invTau, Vector< Matrix< std::complex<double> > >& TEgp )
    {
    ...
    //********************************************************************************************************************************	
    void FarField_1st_ColdPlasma::Get_Non_Regularized_Matrix( Matrix< std::complex<double> >& StiffMatrix ) 
    {
        // Constants
        double pi = 3.14159265358979;
        double mu = pi * 4.0e-7;
